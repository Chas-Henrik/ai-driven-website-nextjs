...
export default function ChatInterface() {
    ...
    return(
        <article className='max-w-[50%] m-auto my-3 p-3 flex flex-col items-center font-sans font-medium text-base text-left'>
            <h1 className='m-2 text-4xl font-bold'>Chat Interface</h1>
            <input className='m-2 p-2 min-w-full border-2 border-solid border-black rounded-md leading-6' type="text" onChange={inputOnChangeHandler} placeholder="Enter your message" />
